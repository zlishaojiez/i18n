...
class I18nHeaderConfigTest {
    ...
    @Nested
    @SpringBootTest(classes = { I18nSpringBoot4Application.class}, properties = {"i18n.resolver=header", "i18n.parameter=accept-language"})
    ...
    @Nested
    @SpringBootTest(classes = { I18nSpringBoot4Application.class}, properties = {"i18n.resolver=header", "i18n.parameter=locale"})
    @Import(I18nHeaderConfig.class)
